...
/**
 * Factory function that returns a SunatClient for the given environment.
 *
 * When environment is 'mock', points at the local mock server (http://localhost:MOCK_SUNAT_PORT).
 * When 'beta' or 'production', points at the real SUNAT endpoints.
 */
